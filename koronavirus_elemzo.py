...
def főprogram():
    ...
    # else:
    for n in range(most_elemzendő_újságcikkek_száma):

      újságcikk_szövege = input("\nÚjságcikk szövege: ")
      a_program_jol_dontott = jol_dontott_e_a_program(újságcikk_szövege)
      if a_program_jol_dontott == True:
...
def jol_dontott_e_a_program(újságcikk_szövege):
  ...
  return valóban_koronavírusos_cikk == a_program_szerint_ez_egy_koronavírusos_cikk
